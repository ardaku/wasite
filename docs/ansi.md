...
-----
 ...
 - `\x1B[38;5;nm` (Since v0.1.0) Set foreground to `n` from
...
-----
 ...
 - `\x1B[48;5;nm` (Since v0.1.0) Set background to `n` from
[Color table](https://www.ditig.com/256-colors-cheat-sheet).
...
# Unicode special codepoints
 ...
 - ENQ `\x05` (Since v1.0.0): Print "column/columns;line/lines" to stdin
   (skips buffer)
 ...
 - TAB `\x09` (Since v0.1.0): Move cursor to the next tab stop (always every 8
   columns)
 - LF `\x0A` (Since v0.1.0): Clear until end of line, move cursor to the
   beginning of the next line
 - VT `\x0B` (Since v0.1.0): Move cursor to the beginning of the next line
   without clearing
